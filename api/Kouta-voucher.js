...
module.exports = [
  {
    ...
    async run(req, res) {
      ...
      res.json({ creator: "PhoenixVisions", status: true, provider: "axis", number, result });
    }
  },
  {
    ...
    async run(req, res) {
      ...
      res.json({ creator: "PhoenixVisions", status: true, provider: "byu", number, result });
    }
  },
  {
    ...
    async run(req, res) {
      ...
      res.json({ creator: "PhoenixVisions", status: true, provider: "indosat", number, result });
    }
  },
  {
    ...
    async run(req, res) {
      ...
      res.json({ creator: "PhoenixVisions", status: true, provider: "smartfren", number, result });
    }
  },
  {
    ...
    async run(req, res) {
      ...
      res.json({ creator: "PhoenixVisions", status: true, provider: "telkomsel", number, result });
    }
  },
  {
    name: "Cek Voucher XL",
    ...
    async run(req, res) {
      ...
      res.json({ creator: "PhoenixVisions", status: true, provider: "xl", number, result });
    }
  }
];
