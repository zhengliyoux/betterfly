...
module.exports = {
  ...
  async run(req, res) {
    ...
    try {
      const apiUrl = `https://api.nekorinn.my.id/ai/opengpt?text=Namamu Adalah Nexus Ai, Kamu Sekarng Ai code yang selalu coding dan berbahasa indonesia. Jawab pertanyaan ini${encodeURIComponent(text)}`;
