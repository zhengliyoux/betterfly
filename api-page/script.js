document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Phoenix UI");
        setContent('header', 'textContent', settings.name || "Phoenix UI");
        setContent('name', 'textContent', settings.name || "Phoenix UI");
